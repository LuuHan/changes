  ...
  for (let i = 0; i < mutationsList.length; i++) {
    for (let j = 0; j < mutationsList[i].removedNodes.length; j++) {
      ...
      if (
        ...
        mutationsList[i].removedNodes[j].innerHTML.includes("puff-loading")
      ) {
  ...
  if (options[SHOW_BREEDS_STATS_OPTION]) {
    ...
    if (
      ...
      imgHolder.style["background-image"] =
        "url(https://imagewerks.s3.us-west-2.amazonaws.com/BJy7iy6Tb/770159246796128258)";
    ...
    if (axie.stage == 3) {
      ...
      if (timeToBirth < timerCheck) {
        ...
        let imgHolder = anc.querySelector(".img-placeholder");
        imgHolder.style["background-image"] =
          "url(https://imagewerks.s3.us-west-2.amazonaws.com/BJy7iy6Tbaaa.com-1654773)";
...
function buildSearchLink(axie) {
  ...
  marketIcon.src =
    "https://imagewerks.s3.us-west-2.amazonaws.com/BJy7iy6Tb/market";
